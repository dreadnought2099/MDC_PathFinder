                ...
                <div class="mb-6 p-4 border rounded bg-blue-50">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2 flex gap-2 flex-wrap">
                            <button type="button" class="quick-select bg-gray-500 text-white px-3 py-1 rounded text-sm cursor-pointer"
                            ...
                            <button type="button"
                                class="clear-select bg-gray-300 text-gray-700 px-3 py-1 rounded text-sm cursor-pointer">Clear All</button>
                        </div>
                    </div>
