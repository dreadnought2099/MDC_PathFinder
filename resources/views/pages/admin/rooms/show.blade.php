                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-8 text-center border-2 border-primary dark:bg-gray-800">
                        ...
                        <div>
                            <a href="{{ route('room.print-qrcode', $room->id) }}" target="_blank"
                                class="inline-flex items-center gap-2 text-white bg-primary border border-primary hover:text-primary hover:bg-white px-4 py-4 text-sm rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 dark:hover:bg-gray-800">
