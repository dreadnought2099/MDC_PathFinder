...
<div class="min-h-screen bg-gray-50 py-8 px-4">
    <div class="max-w-2xl mx-auto">
            ...
            <div class="p-8">
                <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <div class="flex-1 space-y-6">
                        ...
                        <!-- Email -->
                        <div class="border border-gray-200 rounded-xl p-4 hover:border-primary hover:bg-primary-10 transition-all duration-300">
        ...
        <!-- Modal -->
        <div id="imageModal" class="fixed inset-0 bg-black/90 backdrop-blur-sm hidden items-center justify-center z-50 overflow-auto">
            <button onclick="closeModal()"
                    class="fixed top-4 right-4 text-white/80 text-3xl hover:text-red-400 transition-colors duration-300 z-10 bg-black/50 rounded-full w-12 h-12 flex items-center justify-center hover:bg-red-500/20">
                ✕
            </button>
            <div class="relative p-4 flex items-center justify-center">
                <img id="modalImage" src="" alt="Full Image" class="max-w-full max-h-[90vh] object-contain" />
            </div>
        </div>
