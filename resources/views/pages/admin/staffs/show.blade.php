        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div id="imageModal"
                ...
                <button onclick="closeModal()"
                    class="absolute top-6 right-6 text-white text-8xl hover:text-secondary cursor-pointer hover:bg-opacity-50 rounded-full w-12 h-12 flex items-center justify-center transition-all duration-300">
                    &times;
                </button>
                <img id="modalImage" src="" alt="Full Image" class="max-w-full max-h-full rounded-2xl shadow-2xl" />
            </div>
        </div>
    </div>
@endsection
