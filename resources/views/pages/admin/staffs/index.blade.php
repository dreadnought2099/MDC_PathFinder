    ...
    <div class="container mt-4 mx-auto max-w-6xl overflow-y-auto h-[80vh]">
        ...
        <div class="bg-white dark:bg-gray-900 mb-6 text-center sticky top-0 z-48 px-4 sm:px-6 lg:px-8">
            <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-1 dark:text-gray-100">
                <img-reveal>
                    <span class="trigger-text text-primary">Staff</span>
                    <img src="https://cdn.jsdelivr.net/gh/dreadnought2099/MDC_PathFinder/public/gif/bad-shark2.gif"
                ...
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        <p class="text-gray-700 text-sm leading-relaxed dark:text-gray-300">
                            ...
                            <span id="modalStaffName" class="text-secondary"></span>?
