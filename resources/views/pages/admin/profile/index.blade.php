            ...
            <div class="mt-6 border-2 border-amber-300 rounded-lg p-4 bg-amber-50 dark:bg-amber-900/30">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('admin.2fa.recovery.download') }}"
                        class="flex-1 text-center px-4 py-2 bg-primary text-white rounded hover:bg-primary-dark border-2 border-primary hover:bg-white hover:text-primary transition-all duration-300">
