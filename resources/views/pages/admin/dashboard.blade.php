            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-6">
                ...
                @if (auth()->user()->hasRole('Admin') || auth()->user()->can('view rooms'))
                    <a href="{{ route('room.index') }}"
                        ...
                        <div class="flex flex-col items-center text-center space-y-3">
                            <div class="bg-primary-10 hover:bg-primary-20 p-3 rounded-full transition-all duration-300">
                                <img src="https://cdn.jsdelivr.net/gh/dreadnought2099/MDC_PathFinder@9e4a93a/public/icons/manage-office.png"
                                    alt="Manage Offices"
                                    class="h-10 w-10 object-contain group-hover:scale-120 transition-transform duration-300" />
                            </div>
                            <div>
                ...
                @if (auth()->user()->hasRole('Admin') || auth()->user()->can('view staff'))
                    <a href="{{ route('staff.index') }}"
                        ...
                        <div class="flex flex-col items-center text-center space-y-3">
                            <div class="bg-primary-10 hover:bg-primary-20 p-3 rounded-full transition-all duration-300">
                                <img src="https://cdn.jsdelivr.net/gh/dreadnought2099/MDC_PathFinder@9e4a93a/public/icons/manage-staff.png"
                                    alt="Manage Staff"
                                    class="h-10 w-10 object-contain group-hover:scale-120 transition-transform duration-300" />
                            </div>
                            <div>
                ...
                @if (auth()->user()->hasRole('Admin') || auth()->user()->can('view room users'))
                    <a href="{{ route('room-user.index') }}"
                        ...
                        <div class="flex flex-col items-center text-center space-y-3">
                            <div class="bg-primary-10 hover:bg-primary-20 p-3 rounded-full transition-all duration-300">
                                <img src="https://cdn.jsdelivr.net/gh/dreadnought2099/MDC_PathFinder@9e4a93a/public/icons/manage-user.png"
                                    alt="Manage Staff"
                                    class="h-10 w-10 object-contain group-hover:scale-120 transition-transform duration-300" />
                            </div>
                            <div>
