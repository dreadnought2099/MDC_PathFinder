<div>
    ...
    <div class="flex items-center gap-2">
        ...
        <form method="GET" action="{{ $route }}" id="sort-form" class="flex gap-2">
            ...
            <select name="sort" onchange="this.form.submit()" class="border rounded p-1 text-sm">
            ...
            <select name="direction" onchange="this.form.submit()" class="border rounded p-1 text-sm">
